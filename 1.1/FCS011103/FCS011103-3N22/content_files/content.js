...
Q7_Arr = new Array();	
				...
				quesGeneration = function(){
					...
					Q1_Arr[0] = {Q:"1",q1:"2",q2:"20"}
					Q1_Arr[1] = {Q:"2",q1:"3",q2:"30"}
					Q1_Arr[2] = {Q:"3",q1:"4",q2:"40"}
					Q1_Arr[3] = {Q:"4",q1:"5",q2:"50"}
					Q1_Arr[4] = {Q:"5",q1:"6",q2:"60"}
					Q1_Arr[5] = {Q:"6",q1:"7",q2:"70"}
					Q1_Arr[6] = {Q:"7",q1:"8",q2:"80"}
					Q1_Arr[7] = {Q:"8",q1:"9",q2:"90"}
					Q1_Arr[8] = {Q:"9",q1:"10",q2:"100"}
		...
		q1 =  Q1_Arr[next_val]['q1']
		q2 =  Q1_Arr[next_val]['q2']
		/*q3 =  Q1_Arr[next_val]['q3']
		q4 =  Q1_Arr[next_val]['q4']
		q5 =  Q1_Arr[next_val]['q5']*/
		...
		$(".q5").html(q5)*/
			...
			nextQuesGeneration();  ///// Calling question..
				...
				doneButton1111 = function(){
					...
					ent_ans1 = (k1_text).toUpperCase();
					ent_ans2 = (k2_text).toUpperCase();
					...
					if(ent_ans1 == "") {
						...
						} else if ((ent_ans1) == ((Q1_Arr[randomArr[changeimage-1]]['q1'])) && (ent_ans2) == (Q1_Arr[randomArr[changeimage-1]]['q2'])){
			...
			//alert($(".input1").val())
				...
				doneButton = function() {
					...
					//}
						...
						Responseflag="true";
						$(".remark,.respond").css("display","inline-block")
				    if ((ent_ans1) == (Number(q1)) && (ent_ans2) == (Number(q2))){
						 $(".Comma_prompt").hide()
...
*/					
				...
				localStorage.setItem("key",$(".input1").val()+"@serverString@"+$(".input2").val()+"@serverString@"+final_score+"@serverString@"+Q+"@serverString@"+A+"@serverString@"+q1+"@serverString@"+q2+"@serverString@"+Attempted_score);
	...
	var answerString = $(".input1").val()+"@serverString@"+$(".input2").val()+"@serverString@"+final_score+"@serverString@"+Q+"@serverString@"+A+"@serverString@"+q1+"@serverString@"+q2+"@serverString@"+Attempted_score;
