$(document).ready(function(){
			...
			window.textfont = $(".quesStatment").css("font-size");
				...
				$('.tick,.cross').css("font-size",textfont*.75+"px");
	/*------------------------------------------------------------------------------------------------------------------------*/			
...
sol=function(){	
 ...
 //alert(total+" ==total||start== "+start+" ||end== "+end)
	...
	rect_leftCons=(start*30)+70;
	
	rect_left=rect_leftCons;
	
	rect_widthCons=(total-start)*30;
...
iPlusPlus++;
	...
	if(iPlusPlus<=1){
		...
		//alert(totalNew)
 		 $(".linedL_"+(Number(totalNew+1))).css({ fill: "red" });
		 $(".linedL_"+(totalNew+1)).css({ stroke: "red" });
		 $(".AS"+(Number(totalNew+2))).css({ fill: "red" });
		 $(".AS"+(totalNew+2)).css({ stroke: "red" });
		 $(".Nlined_"+(Number(totalNew))).css({ fill: "red"});
		 $(".Nlined_"+(totalNew)).css({ stroke: "red"});
		 $(".aa"+(Number(totalNew+3))).css({ fill: "green" });
		 $(".aa"+(totalNew+3)).css({ stroke: "green" });
		 $(".bb"+(Number(totalNew-1))).css({ fill: "green" });
		 $(".bb"+(totalNew-1)).css({ stroke: "green" });
...
if(numStart<total){
	...
	$(".lined_"+totalNew).text(num_check);	
