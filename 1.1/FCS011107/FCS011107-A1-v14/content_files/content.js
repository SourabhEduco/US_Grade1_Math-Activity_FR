...
$(document).ready(function(){
 ...
 $(".A2").show();
 BiggestImage = $(".A2").css("height");
 $(".A2").hide();

 BiggestImage = parseInt(BiggestImage);
 $(".AllImages").css("height",BiggestImage+"px");
  $(".DivForRadioBtns").css("min-height",BiggestImage+"px");
 $(".RadioBtnDiv").css("margin-top",(BiggestImage/2)*.4+"px");
...
Q7_Arr = new Array();	
			...
			/* for (var i = 0; i<array_Range; i++) {
				...
				var num1 = randRange(11, 85);
				var num2 = randRange(11, 85);
				var num3 = randRange(11, 85);
				var num4 = randRange(11, 85);
				 var num9 = randRange(1, 4);
				 
				var num5 = convertNumberToWordsSS1(num1);
				var num6 = convertNumberToWordsSS1(num2);
				var num7 = convertNumberToWordsSS1(num3);
				var num8 = convertNumberToWordsSS1(num4);
				 
				 
				    var num10 =num1%10;
					var num11 = num1-num10;
				 
				 
				 
				 var num12 = convertNumberToWordsSS1(num10);
				var num13 = convertNumberToWordsSS1(num11);
				 
				 
				 if(num1!=num2 && num1!=num3 && num1!=num4 && num2!=num3 && num2!=num4 && num3!=num4){
					 
				Q1_Arr.push(num1+"@"+num2+"@"+num3+"@"+num4+"@"+num5+"@"+num6+"@"+num7+"@"+num8+"@"+num9+"@"+num10+"@"+num11+"@"+num12+"@"+num13);
				 ...
				 Q1_Arr = Remove_Duplicate_Entry(String(Q1_Arr))
					*/
					...
					Q1_Arr = ["29@61@80@47@Twenty - nine @Sixty - one @Eighty @Forty - seven @4@9@20@Nine @Twenty ","35@74@12@48@Thirty - five @Seventy - four @Twelve @Forty - eight @2@5@30@Five @Thirty ","57@29@50@78@Fifty - seven @Twenty - nine @Fifty @Seventy - eight @4@7@50@Seven @Fifty ","49@80@68@52@Forty - nine @Eighty @Sixty - eight @Fifty - two @3@9@40@Nine @Forty ","15@21@55@49@Fifteen @Twenty - one @Fifty - five @Forty - nine @4@5@10@Five @Ten ","42@45@62@39@Forty - two @Forty - five @Sixty - two @Thirty - nine @3@2@40@Two @Forty ","60@57@84@47@Sixty @Fifty - seven @Eighty - four @Forty - seven @4@0@60@@Sixty ","56@41@29@76@Fifty - six @Forty - one @Twenty - nine @Seventy - six @3@6@50@Six @Fifty ","81@37@52@20@Eighty - one @Thirty - seven @Fifty - two @Twenty @3@1@80@One @Eighty ","53@32@49@68@Fifty - three @Thirty - two @Forty - nine @Sixty - eight @2@3@50@Three @Fifty ","31@26@76@37@Thirty - one @Twenty - six @Seventy - six @Thirty - seven @2@1@30@One @Thirty ","58@32@46@67@Fifty - eight @Thirty - two @Forty - six @Sixty - seven @3@8@50@Eight @Fifty ","64@47@65@33@Sixty - four @Forty - seven @Sixty - five @Thirty - three @3@4@60@Four @Sixty ","17@68@23@24@Seventeen @Sixty - eight @Twenty - three @Twenty - four @2@7@10@Seven @Ten"]
	...
	temp_str = String(Q1_Arr[next_val]).split("@")
				...
				var val8 = temp_str[7];
				var val9 = temp_str[8];
				var val10 = temp_str[9];
				var val11 = temp_str[10];
				var val12 = temp_str[11];
				var val13 = temp_str[12];
        ...
        radioReturn4= function(num){
			...
			radioOption();
					...
					/*alert(val5 == numberRadio )
					alert(val5+" == "+numberRadio)*/
					if(numberRadio == 1){
						
						
						 $(".remark,.correct").show().delay(2500).hide(0);
						...
						$(".incorrect").hide()
						 ...
						 $(".remark,.incorrect").show().delay(2500).hide(0);
				...
				function preloadans(strfrmServer) {
					...
					//localStorage.setItem("key",numberRadio+"@serverString@"+temp_str+"@serverString@"+radioId+"@serverString@"+final_score+"@serverString@"+Attempted_score);
						...
						}else if(numberRadio == 3){
							$('input[id="c-option"]').prop('checked',true); 
						}else if(numberRadio == 4){
							$('input[id="d-option"]').prop('checked',true); 
						}else{
	 ...
	 var answerString = numberRadio+"@serverString@"+temp_str+"@serverString@"+radioId+"@serverString@"+final_score+"@serverString@"+Attempted_score;
