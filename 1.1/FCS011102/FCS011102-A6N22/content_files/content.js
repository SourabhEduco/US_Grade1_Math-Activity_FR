...
Q7_Arr = new Array();	
			window.randomArr = new Array();		
				...
				quesGeneration = function(){
					...
					Q1_Arr[0] = {Q:"1",A:"11",A1:"1"}
					Q1_Arr[1] = {Q:"2",A:"12",A1:"2"}
					Q1_Arr[2] = {Q:"3",A:"13",A1:"3"}
					Q1_Arr[3] = {Q:"4",A:"14",A1:"4"}
					Q1_Arr[4] = {Q:"5",A:"15",A1:"5"}
					Q1_Arr[5] = {Q:"6",A:"16",A1:"6"}
					Q1_Arr[6] = {Q:"7",A:"17",A1:"7"}
					Q1_Arr[7] = {Q:"8",A:"18",A1:"8"}
					Q1_Arr[8] = {Q:"9",A:"19",A1:"9"}
...
*/					
				...
				localStorage.setItem("key",k1_text+"@serverString@"+final_score+"@serverString@"+Q+"@serverString@"+A+"@serverString@"+A1+"@serverString@"+Attempted_score);
	...
	var answerString = k1_text+"@serverString@"+final_score+"@serverString@"+Q+"@serverString@"+A+"@serverString@"+A1+"@serverString@"+Attempted_score;
