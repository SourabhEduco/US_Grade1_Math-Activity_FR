$(document).ready(function(){
  ...
  return result    
	...
	Subtraction = function(num1,num2,length)
			{
				
				num1split = String(num1).split("")
				num2split = String(num2).split("")
				num3split = String(num1).split("")
				
				for(i=length;i>1;i--)
				{
				if(num1split[i]<num2split[i])
				{
					num1split[i] = Number(num1split[i])+10
					num1split[i-1] = Number(num1split[i-1])-1
				}
